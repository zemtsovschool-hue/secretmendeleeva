        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-gradient-to-br from-orange-800/20 to-red-800/20 backdrop-blur-sm rounded-2xl p-6 border border-orange-400/20 hover:border-orange-400/50 transition-all duration-300 transform hover:scale-105">
              <div className="text-5xl mb-4">💫</div>
              <h4 className="text-xl font-bold mb-3 text-orange-300">Двухуровневое закрепление</h4>
              <p className="text-gray-300 text-sm leading-relaxed">Сначала тест у Менделеева во сне (5 вопросов), потом финальная контрольная (10 вопросов). Спиралевидное закрепление материала для лучшего запоминания.</p>
            </div>
          ...
          <div className="bg-gradient-to-r from-purple-900/40 to-pink-900/40 backdrop-blur-sm rounded-3xl p-8 sm:p-12 border border-purple-400/30 mb-16">
            <h3 className="text-3xl font-bold mb-8 text-center">Доказанная эффективность обучения</h3>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-sm rounded-3xl overflow-hidden border border-purple-400/30 aspect-video">
              ...
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-indigo-900/50 to-purple-900/50">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">{screenshots[currentScreenshot].desc}</p>
                  <button
                    onClick={() => openLightbox(screenshots[currentScreenshot])}
                    className="mt-4 px-6 py-2 bg-purple-600 hover:bg-purple-700 rounded-full flex items-center gap-2 mx-auto transition-all"
                  >
              ...
              {/* <img 
                src={`/screenshots/${currentScreenshot + 1}.jpg`} 
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 mt-8">
            {screenshots.map((screenshot, index) => (
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-purple-800/30 to-pink-800/30 flex items-center justify-center">
                  <span className="text-2xl font-bold text-purple-400">{screenshot.id}</span>
                </div>
                {/* Замените на реальные миниатюры: */}
                {/* <img src={`/screenshots/thumb-${screenshot.id}.jpg`} alt={screenshot.title} className="w-full h-full object-cover" /> */}
              </button>
            ))}
          </div>
        </div>
